...
function checkUserVerification() {
    ...
    if(nm == "") {   //check empty name field
        document.getElementById("nmmsg").innerHTML = "*Name Field is Empty!";  
        flag = false;  
    }

    else if(/\d/.test(nm)) {  //check if name has numbers
        document.getElementById("nmmsg").innerHTML = "*Names Should Not Contain Numbers and Special Characters";  
        flag = false;  
    }
