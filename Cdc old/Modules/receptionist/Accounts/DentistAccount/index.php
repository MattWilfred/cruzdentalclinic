...
<html lang=e n dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="css/DentistAccount-Style.css?v=<?php echo time(); ?>">
...
if (isset($_POST["submitsearch"])){
    ...
    $entries = mysqli_query($connection, "SELECT * FROM users WHERE username LIKE '$searchedTerm' || fname LIKE '$searchedTerm' || lname LIKE '$searchedTerm'");
