  ...
  <div class="container">
    ...
    <div class="main-body">
      ...
      <div class="promo_card">
        ...
        <a href="/Modules/receptionist/Accounts/SecretaryAccount/view.php?id=<?php echo $id;?>"><button>View Profile</button></a>
      ...
      <div class="history_lists">
        <div class="list1">
          <div class="row">
            ...
            <a href="/Modules/receptionist/php-calendar/schedule-list.php">See all</a>
          </div>
          <table id="tbl_appt">
            <thead>
              <tr>
