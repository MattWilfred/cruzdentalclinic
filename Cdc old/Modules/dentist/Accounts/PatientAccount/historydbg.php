    ...
    ?>
        ...
        <div class="navbar">
            ...
            <div class="dental-bg">
                ...
                $dbgid = $_GET['view-button'];

                $query = fetchUniqueDentalBG($dbgid);
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td><button class='dbg-viewbutton btn btn-primary' type='submit' name='view-button' value='" .$hrow['dental_background_id']. "'>View</button></td>";
                                echo "</tr>";
