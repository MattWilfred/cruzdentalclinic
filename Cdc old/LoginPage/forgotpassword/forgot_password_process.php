...
require ("$_SERVER[DOCUMENT_ROOT]/Database/connect.php");
    ...
    try {
        ...
        $mail->Body    = 'To reset your password click <a href="http://127.0.0.1/LoginPage/forgotpassword/change_password.php?code='.$code.'">here </a>. </br>Reset your password in a day.';
