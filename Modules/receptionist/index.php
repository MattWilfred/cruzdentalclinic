                ...
                <div class="patient">
                    ...
                    <div class="patient-info ">
                        <div class="col1">
                            <div>
                                ...
                                <p><?php overalltotalUpcomingApt();?></p>
                            </div>
                        </div>
                        <div class="col2">
                            <div>
                                <h3>Total Appointments</h3>
                                <p><?php overalltotalAppt();?></p>
                            </div>
                        </div>
                        <div class="col3">
                            <div>
                                <h3>Total No. of Patients</h3>
                                <p><?php overalltotalPatients();?></p>
                            </div>
                        </div>
                    ...
                    <h4> Announcement </h4>
                        ...
                        <?php
                                ...
                                $query_presc = "SELECT * from announcement ORDER BY date LIMIT 5 ";
                        ...
                        ?>
                            ...
                            <a href="announcement/announcement.php"><button class="annc-btn"><b>View</b></button></a>
                            </div>
