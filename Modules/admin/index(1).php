  ...
  <div class="container">
    ...
    <div class="main-body">
      ...
      <div class="promo_card">
        ...
        <a href="/Modules/admin/Accounts/SecretaryAccount/view.php?id=<?php echo $id;?>"><button>View Profile</button></a>
      ...
      <div class="history_lists">
        <div class="list1">
          <div class="row">
            ...
            <a href="/Modules/admin/php-calendar/schedule-list.php">See all</a>
          </div>
          <table id="tbl_appt">
            <thead>
              <tr>
        ...
        <div class="list2">
          <div class="row">
            <h4>Announcement</h4>
            <a href="/Modules/admin/announcement/announcement.php">See More</a>
          </div>
          <table>
            <thead>
              <tr>
