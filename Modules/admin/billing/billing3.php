...
function fetchSOADetails(){
    global $conn;
    $soa = mysqli_query($conn, "SELECT * FROM transaction AS a INNER JOIN statement_of_account AS b ON a.transaction_id = b.transaction_id INNER JOIN users_credentials AS c ON a.user_id=c.user_id INNER JOIN patients AS d ON a.user_id = d.user_id");
    return $soa;
}
    ...
    <div class="cont">
            ...
            <table>
                ...
                $query = fetchSOADetails();
                    ...
                    if(mysqli_num_rows($query) > 0){
                        ...
                        while($rows= mysqli_fetch_assoc($query)){
                            ...
                            echo "<tr>";
                                echo "<td class='uid'>" .$rows['patient_first_name']. " ".$rows['patient_surname'].  "</td>";
             ...
             <div class="overlay" id="divOne">
                ...
                <form name="transaction-form" method="POST" action="add-transaction.php">
                    ...
                    <div class="row3">    
                        <div class="input-box2" id="in-div2">
                        ...
                        <div class="input-box3">
                            <span class="details">Price</span>
                            <input class="price-input" id="amount2" type="price" name="opr" value="0" required>
                            <button onclick="addAdditionalOtherProcedure()" id="plus-btn">+</button>
                        </div>
                    </div>  

                    <div class="container1" style="padding-left: 30px">
                        <h2>Total Amount</h2>
        ...
        <script>
            ...
            function addAdditionalProcedure() {
                ...
                s.setAttribute('name','procedure-dds');
                ...
                i.setAttribute('name','prc[]');

                card.append(i);

                //let target = document.getElementById("in-div-left")
                document.getElementById("in-div-left").append(card);
            }
